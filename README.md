#Animeflix
> An anime streaming site linked into MAL..

[![Build Status](https://travis-ci.org//animeflix.svg?branch=master)](https://travis-ci.org//animeflix) [![Dependency Status](https://david-dm.org//animeflix.svg)](https://david-dm.org//animeflix) [![devDependency Status](https://david-dm.org//animeflix/dev-status.svg)](https://david-dm.org//animeflix#info=devDependencies)
...
## Release History
 * 2014-08-21   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)